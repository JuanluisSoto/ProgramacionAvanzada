...
SURVIVALARENA_API UClass* Z_Construct_UClass_AStrategyPlayerController();
SURVIVALARENA_API UClass* Z_Construct_UClass_AStrategyPlayerController_NoRegister();
SURVIVALARENA_API UClass* Z_Construct_UClass_AStrategyUnit_NoRegister();
SURVIVALARENA_API UEnum* Z_Construct_UEnum_SurvivalArena_EStrategyInputMode();
...
static UEnum* EStrategyInputMode_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SurvivalArena_EStrategyInputMode, (UObject*)Z_Construct_UPackage__Script_SurvivalArena(), TEXT("EStrategyInputMode"));
	}
	return Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton;
}
template<> SURVIVALARENA_API UEnum* StaticEnum<EStrategyInputMode>()
{
	return EStrategyInputMode_StaticEnum();
}
struct Z_Construct_UEnum_SurvivalArena_EStrategyInputMode_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SurvivalArena_EStrategyInputMode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_SurvivalArena,
	nullptr,
	"EStrategyInputMode",
	"EStrategyInputMode",
	Z_Construct_UEnum_SurvivalArena_EStrategyInputMode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_SurvivalArena_EStrategyInputMode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::Regular,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SurvivalArena_EStrategyInputMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SurvivalArena_EStrategyInputMode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_SurvivalArena_EStrategyInputMode()
{
	if (!Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton, Z_Construct_UEnum_SurvivalArena_EStrategyInputMode_Statics::EnumParams);
	}
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_InputMode = { "InputMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrategyPlayerController, InputMode), Z_Construct_UEnum_SurvivalArena_EStrategyInputMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InputMode_MetaData), NewProp_InputMode_MetaData) }; // 330978341
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyPlayerController_h__Script_SurvivalArena_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EStrategyInputMode_StaticEnum, TEXT("EStrategyInputMode"), &Z_Registration_Info_UEnum_EStrategyInputMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 330978341U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStrategyPlayerController, AStrategyPlayerController::StaticClass, TEXT("AStrategyPlayerController"), &Z_Registration_Info_UClass_AStrategyPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStrategyPlayerController), 439285968U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyPlayerController_h__Script_SurvivalArena_2878076254(TEXT("/Script/SurvivalArena"),
	Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyPlayerController_h__Script_SurvivalArena_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyPlayerController_h__Script_SurvivalArena_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyPlayerController_h__Script_SurvivalArena_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyPlayerController_h__Script_SurvivalArena_Statics::EnumInfo));
// ********** End Registration *********************************************************************
