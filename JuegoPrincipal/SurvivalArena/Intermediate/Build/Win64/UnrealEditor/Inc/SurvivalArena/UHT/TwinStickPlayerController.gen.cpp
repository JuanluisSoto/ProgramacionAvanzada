...
SURVIVALARENA_API UClass* Z_Construct_UClass_ATwinStickPlayerController();
SURVIVALARENA_API UClass* Z_Construct_UClass_ATwinStickPlayerController_NoRegister();
...
struct Z_Construct_UClass_ATwinStickPlayerController_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MaxLives_MetaData[] = {
		...
		{ "ClampMin", "1" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Maximum lives per round */" },
#endif
		{ "ModuleRelativePath", "Variant_TwinStick/TwinStickPlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Maximum lives per round" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Lives_MetaData[] = {
		{ "Category", "Lives" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Current remaining lives */" },
#endif
		{ "ModuleRelativePath", "Variant_TwinStick/TwinStickPlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Current remaining lives" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DeathScorePenalty_MetaData[] = {
		{ "Category", "Lives" },
		{ "ClampMax", "1000" },
		{ "ClampMin", "0" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Score penalty applied on each death */" },
#endif
		{ "ModuleRelativePath", "Variant_TwinStick/TwinStickPlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Score penalty applied on each death" },
#endif
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp_DeathScorePenalty;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ATwinStickPlayerController_Statics::NewProp_MaxLives = { "MaxLives", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATwinStickPlayerController, MaxLives), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxLives_MetaData), NewProp_MaxLives_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ATwinStickPlayerController_Statics::NewProp_Lives = { "Lives", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATwinStickPlayerController, Lives), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Lives_MetaData), NewProp_Lives_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ATwinStickPlayerController_Statics::NewProp_DeathScorePenalty = { "DeathScorePenalty", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATwinStickPlayerController, DeathScorePenalty), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DeathScorePenalty_MetaData), NewProp_DeathScorePenalty_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATwinStickPlayerController_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATwinStickPlayerController_Statics::NewProp_MaxLives,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATwinStickPlayerController_Statics::NewProp_Lives,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATwinStickPlayerController_Statics::NewProp_DeathScorePenalty,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_TwinStick_TwinStickPlayerController_h__Script_SurvivalArena_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATwinStickPlayerController, ATwinStickPlayerController::StaticClass, TEXT("ATwinStickPlayerController"), &Z_Registration_Info_UClass_ATwinStickPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATwinStickPlayerController), 2677217333U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_TwinStick_TwinStickPlayerController_h__Script_SurvivalArena_1319881486(TEXT("/Script/SurvivalArena"),
	Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_TwinStick_TwinStickPlayerController_h__Script_SurvivalArena_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_TwinStick_TwinStickPlayerController_h__Script_SurvivalArena_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
