...
SURVIVALARENA_API UClass* Z_Construct_UClass_AStrategyUnit();
...
struct Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics
{
	struct _Script_SurvivalArena_eventOnUnitMoveCompletedDelegate_Parms
	{
		AStrategyUnit* Unit;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::NewProp_Unit = { "Unit", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_SurvivalArena_eventOnUnitMoveCompletedDelegate_Parms, Unit), Z_Construct_UClass_AStrategyUnit_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::NewProp_Unit,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_SurvivalArena, nullptr, "OnUnitMoveCompletedDelegate__DelegateSignature", Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::_Script_SurvivalArena_eventOnUnitMoveCompletedDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::_Script_SurvivalArena_eventOnUnitMoveCompletedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_SurvivalArena_OnUnitMoveCompletedDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FOnUnitMoveCompletedDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnUnitMoveCompletedDelegate, AStrategyUnit* Unit)
{
	...
	_Script_SurvivalArena_eventOnUnitMoveCompletedDelegate_Parms Parms;
	Parms.Unit=Unit;
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyUnit_h__Script_SurvivalArena_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStrategyUnit, AStrategyUnit::StaticClass, TEXT("AStrategyUnit"), &Z_Registration_Info_UClass_AStrategyUnit, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStrategyUnit), 2367020715U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyUnit_h__Script_SurvivalArena_1628310023(TEXT("/Script/SurvivalArena"),
	Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyUnit_h__Script_SurvivalArena_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Juan_Luis_Desktop_ProgramacionAvanzada_JuegoPrincipal_SurvivalArena_Source_SurvivalArena_Variant_Strategy_StrategyUnit_h__Script_SurvivalArena_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
